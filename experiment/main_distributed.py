...
def main():
    ...
    match args.operation:
        case "c":
            ddl.create_table_distributed(config)
        case "d":
            ddl.delete_table(config)
        case "i":
            dml.load_csv_to_db_distributed(config, args)
        case "s":
...
def parse_args():
    ...
    parser.add_argument('--config', default='distributed',
                        help='config file name')

    # create drop insert select restart test join_bench
    # c d i s r t b
    parser.add_argument('--operation', default='s',
                        help='operation name')

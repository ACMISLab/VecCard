...
import model.treegru.treegru as TGRU
import argparse
...
def main():
    ...
    if args.retrain:
        ...
        model = TGRU.TreeGRU(input_dim, args.embedding_hidden_dim, args.lstm_hidden_dim,
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch TreeGRU')
    parser.add_argument('--model_name', default="tree-gru-attention",
                        help='model name'),

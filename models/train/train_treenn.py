...
import model.treenn.treenn as TNN
import argparse
...
def main():
    ...
    if args.retrain:
        ...
        model = TNN.TreeNN(input_dim, args.embedding_hidden_dim,
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch TreeNN')
    parser.add_argument('--model_name', default="tree-mlp",
                        help='model name')

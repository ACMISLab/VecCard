 ...
 * predicate max = 8
 */
public class GenerateMcxUserSQL {
    ...
    public static List<String> GenerateSixPredicate(int extractCount){
        JSONObject user = JSONFileReader.getJSONObejct("data/sample/mcx-user.json");
        List<String> gender  =  GeneratorUtils.getColumnValue(user.getJSONArray("gender"), 0);
        List<String> school  =  GeneratorUtils.getColumnValue(user.getJSONArray("school"), 0);
        List<String> year = GeneratorUtils.getColumnValue(user.getJSONArray("year"), 0);
        List<String> genderPredicates = GeneratorUtils.singlePredicateForStringType("gender", gender);
        List<String> schoolPredicates = GeneratorUtils.singlePredicateForStringType("school", school);
        ...
        totalSinglePredicate.add(genderPredicates);
        totalSinglePredicate.add(schoolPredicates);
    ...
    public static List<String> GenerateOnePredicate(int extractCount) {
        ...
        totalSinglePredicate.addAll(genderPredicates);
        totalSinglePredicate.addAll(schoolPredicates);
